package de.scopevisio.data.store;
...
import de.scopevisio.data.repository.CarRepository;
import de.scopevisio.data.repository.ClientRepository;
import de.scopevisio.data.store.exception.NotFoundException;
...
public class CarStore {
    ...
    public Car updateCar(final Car newCar) {
        CarEntity carEntity = carRepository.findById(newCar.getCarId())
                .orElseThrow(() -> new NotFoundException("Car not found"));
        return carRepository.saveAndFlush(mapTheNewCar(carEntity, newCar.modelToEntity())).entityToModel();
    }
